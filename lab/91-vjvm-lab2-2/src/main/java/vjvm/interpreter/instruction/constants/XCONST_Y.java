...
public class XCONST_Y<T> extends Instruction {
  ...
  public static final XCONST_Y DCONST_0(ProgramCounter pc, MethodInfo method) {
    return new XCONST_Y<Double> (0.0, OperandStack::pushDouble, "dconst_0");
  }

  public static final XCONST_Y DCONST_1(ProgramCounter pc, MethodInfo method) {
    return new XCONST_Y<Double> (1.0, OperandStack::pushDouble, "dconst_1");
  }

  public static final XCONST_Y FCONST_0(ProgramCounter pc, MethodInfo method) {
    return new XCONST_Y<Float> (0f, OperandStack::pushFloat, "fconst_0");
  }

  public static final XCONST_Y FCONST_1(ProgramCounter pc, MethodInfo method) {
    return new XCONST_Y<Float> (1f, OperandStack::pushFloat, "fconst_1");
  }

  public static final XCONST_Y FCONST_2(ProgramCounter pc, MethodInfo method) {
