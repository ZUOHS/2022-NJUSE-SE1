...
public class Game {
    ...
    public Result playGame(String gameMode, String moveStr, int size){
    	Board board = new Board(size, gameMode.charAt(0) == '0'?new GameChessStrategy():new GameChessStrategy_F(),
				gameMode.charAt(1) == '0'? new GameWinStrategy_HVD():new GameWinStrategy_HV());
